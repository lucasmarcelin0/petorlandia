...
@app.route('/consulta/<int:consulta_id>/sugestoes_clinicas/protocolos/<int:protocol_id>', methods=['GET'])
@login_required
...
@app.route('/consulta/<int:consulta_id>/sugestoes_clinicas/protocolos/<int:protocol_id>', methods=['PUT'])
@login_required
