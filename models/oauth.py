...
class OAuthClient(db.Model):
    ...
    scopes = db.Column(db.Text, nullable=False, default="openid profile email")
...
class OAuthAuthorizationCode(db.Model):
    ...
    scope = db.Column(db.Text, nullable=False, default="openid")
...
class OAuthAccessToken(db.Model):
    ...
    resource = db.Column(db.String(512), nullable=True, index=True)
